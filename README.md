...
4. In the root directory, run `python3 src/model/save_agop/nfm.py <config_file>` to save the neural feature matrix and averge gradient outer product to local directory for further training.
